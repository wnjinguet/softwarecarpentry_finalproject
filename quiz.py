...
# Afterwards, there is a portion that reveals the user's score. Based on that score, they either get a celebratory message or a message prompting them to continue to practice, based on their score. 
